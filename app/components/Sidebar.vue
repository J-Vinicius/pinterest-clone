  ...
  >
    ...
    <Sidebar collapsible="none" class="hidden flex-1 md:flex">
      ...
      <SidebarContent>
        ...
        sint eveniet? Incidunt porro natus laudantium fuga ratione deleniti sint
        eius quasi dolorem labore. Quo laborum laudantium reprehenderit
        aspernatur repellendus fugiat!
      </SidebarContent>
    </Sidebar>
  </Sidebar>
</template>
